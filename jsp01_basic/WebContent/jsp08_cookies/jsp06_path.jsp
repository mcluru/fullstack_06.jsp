...
<body>
	<h1>쿠키 경로 지정하기</h1>
	<%
		// 1. 경로를 path1로 지정해서 쿠키를 추가
		Cookie cookie1 = new Cookie("path1", URLEncoder.encode("경로:/jsp01_basic/jsp08_cookiew/path1", "utf-8"));
		cookie1.setPath("/jsp01_basic/jsp08_cookiew/path1");
		...
		Cookie cookie4 = new Cookie("path2", URLEncoder.encode("경로:/jsp01_basic/jsp08_cookiew/path2", "utf-8"));
		cookie4.setPath("/jsp01_basic/jsp08_cookiew/path2");
