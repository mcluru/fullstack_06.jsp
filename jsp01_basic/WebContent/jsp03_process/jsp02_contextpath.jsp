...
<!-- 
	...
	강제화하고 있다. 이 구조를 모르면 제대로 동작하는 프로그램을 개발할 수 없다.
	...
	... WEB_INF/lib 	: 웹애플리케이션에서 사용하는 라이브러리파일이 위치(ex: ojdbc8.jar)
	...
	B. 웹애플리케이션의 배포(deploy)
		개발된 웹애플리케이션을 WAS에 배포하는 방법
		
		a. 개발된 프로그램의 폴더 그대로 파일을 WAS에 복사하는 방법(ex:c:/tomcat/webapps\root)
		b. war파일형식으로 압출해서 배포하는 방법
		   ... jdk의 jar.exe명령을 사용해서 war파일을 생성
		   ... 실행방법 c:\jar.exe cvf jsp01_basic.war
		   ... 상기명령 대신 이클립스를 이용 : 프로젝트이름 우클릭 -> export -> war file
