...
<!-- 
	...
	2. Action Tag의 종류
		...
		jsp:useBean : JSP페이지에 Java Beans를 설정(ex: BoardVO)
		jsp:setProperty : Java Beans의 값을 설정(ex: BoardVO의 setter역할)
		jsp:getProperty : Java Beans의 값을 설정(ex: BoardVO의 getter역할)
