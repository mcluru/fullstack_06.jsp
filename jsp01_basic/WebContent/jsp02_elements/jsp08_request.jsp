...
<!-- 
	...
	jsp페이지에서 가장 많이 사용되는 객체. 웹브라우저의 요청과 관련있는 객체다.
	웹브라우저에서 웹사이트주소를 입력하면 웹브라우저는 해당 주소의 웹서버에
	연결한 후 요청정보를 전송하는데, 이 요청 정보를 웹서버에 전달하는 객체가
	request객체다.
	
	A. request객체가 제공하는 기능
		1. 클라이언트(웹브라우저)와 관련된 정보
		2. 서버와 관련된 정보
		3. 클라이언트가 전송한 요청파라미터 정보(http://localhost:8088/login?userid=hong&pw=12345)
		4. 클라이언트가 전송한 요청헤더 정보(http규약에 따른 정보 등..)
		5. 클라이언트가 전송한 쿠키정보
		6. 속성처리 정보
