...
<!-- 
	...
	커넥션풀 기법이란?
	데이터베이스와 커넥션을 사전에 만들어 pool에 저장해두고 필요할때마다 풀에서 꺼내 사용 후
	다시 pool에 반환하는 기법.
	
	커넥션풀의 특징
	1. 사전에 풀에 Connection이 생성되어 있으므로 커넥션을 생성하는 데 필요한 기간을 감소시킨다.
	2. Connection을 재사용하기 때문에 생성되는 Connection갯수를 일정하게 관리할 수 있다.
	3. Connection Pool을 사용하면 웹애플리케이션의 성능과 처리성능이 향상되므로
...
<body>
	<div class="container" align="center">
		<h1>회원등록</h1>
		<div class="row">
			<table class="table table-borderd table-dark table-over">
				<tr>
					<th>아이디</th>
					<th>비밀번호</th>
					<th>이름</th>
